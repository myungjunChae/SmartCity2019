...
if __name__ == '__main__':
    # get image for dir
    image_file = []
    walkPath = os.getcwd() + '/saved_image'
    ...
    # goods detection
    goods_detector = ObjectDetector(MODEL_PATH='models/goods/', NUM_CLASSES=7)

    # hands detection
    hands_detector = ObjectDetector(MODEL_PATH='models/hands/', NUM_CLASSES=1)
